...
class EdgarCLISetup:
    ...
    def create_environment_config(self):
        ...
        if not env_template.exists():
            print(
                "❌ .env.template not found. Please ensure it exists in the project root."
            )
            return
        ...
        print("")
        print(
            "   ⚠️  IMPORTANT: Replace 'your_openrouter_api_key_here' with your actual API key"
        )
...
"""
        ...
        print("   🐧 Unix/Linux/macOS: ./edgar_cli.sh")
        print("   🪟 Windows: edgar_cli.bat")
