"""
OpenRouter Client for Extract Transform Platform

This module provides a clean, typed interface to the OpenRouter API for
AI-powered pattern detection and code generation.
...
- **Model Agnostic**: Works with any OpenRouter-supported model
...
Migration Notes:
- Migrated from edgar_analyzer.clients.openrouter_client
- Removed EDGAR-specific model configurations
- Kept all core functionality and error handling
- 100% code reuse from proven implementation
"""
...
class OpenRouterClient:
    """
    Client for OpenRouter API with comprehensive error handling.
    ...
    # Default model capabilities (can be extended by applications)
    ...
    def __init__(
        ...
        Args:
            ...
            custom_capabilities: Custom model capabilities (extends defaults)
        ...
        self.model_capabilities = dict(self.DEFAULT_MODEL_CAPABILITIES)
        if custom_capabilities:
            self.model_capabilities.update(custom_capabilities)
    ...
    def register_model(self, model: str, capabilities: ModelCapabilities) -> None:
        ...
        This allows applications to add custom model configurations.
        ...
        Example:
            ...
            ...     "custom/model",
            ...     ModelCapabilities(max_tokens=4000, context_window=8000)
            ... )
        """
