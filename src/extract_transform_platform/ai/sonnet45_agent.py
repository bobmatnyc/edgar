...
Migration Status: MIGRATED from EDGAR (1M-380, T5)
- Origin: edgar_analyzer.agents.sonnet45_agent
- Platform: extract_transform_platform.ai.sonnet45_agent
- Code reuse: 100% (753 LOC preserved)
...
from extract_transform_platform.models.patterns import Pattern, ParsedExamples
