...
Code Reuse: 90% from EDGAR ExcelDataSource (proven implementation)
...
class ExcelDataSource(BaseDataSource):
    ...
    Code Reuse: 90% from EDGAR
    - Zero EDGAR-specific code removed (was already 100% generic)
    - Only import path changed (base.py → core.base)
