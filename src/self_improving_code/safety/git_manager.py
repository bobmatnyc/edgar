...
class GitSafetyManager(SafetyManager):
    ...
    def create_checkpoint(self, message: str) -> str:
        ...
        try:
            ...
            subprocess.run(['git', 'stash', 'push', '-m', f'Pre-checkpoint stash: {message}'], 
    ...
    def rollback_to_checkpoint(self, checkpoint_id: str) -> bool:
        ...
        try:
            ...
            subprocess.run(['git', 'branch', '-D', checkpoint_id], 
                         check=True, capture_output=True, text=True)
            ...
            logger.error("Failed to rollback to checkpoint", 
