                ...
                if tag in us_gaap:
                    ...
                    if "USD" in units:
                        for fact in units["USD"]:
                            ...
                            if fact.get("fy") == year and fact.get("form") in [
                                "10-K",
                                "10-K/A",
                            ]:
                                return fact.get("val")
...
def main():
    ...
    for symbol, cik in SAMPLE_COMPANIES.items():
        ...
        if facts:
            ...
            print(
                f"  Tax Expense 2023: ${tax_expense_2023:,.0f}"
                if tax_expense_2023
                else "  Tax Expense 2023: Not found"
            )
        ...
        results.append(
            {
                ...
                "Proxy_Filings_2024": (
                    len(proxy_filings) if "proxy_filings" in locals() else 0
                ),
            }
        )
