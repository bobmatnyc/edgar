...
async def analyze_breakthrough_results(results: List[Dict]):
    ...
    if breakthrough_success_rate > current_success_rate:
        improvement = (breakthrough_success_rate - current_success_rate) / current_success_rate * 100
    ...
    if successful_results:
        ...
        for result in successful_results:
            ...
            print(f"   🏢 {company_name}: {len(executives)} executives, ${company_total/1_000_000:.1f}M total")
    ...
    print(f"   Breakthrough XBRL System: {breakthrough_success_rate*100:.1f}% success rate")
    ...
    return {
        ...
        'improvement_over_current': improvement if breakthrough_success_rate > current_success_rate else 0,
    ...
    with open(results_file, 'w') as f:
        json.dump({
            ...
            'breakthrough_discovery': {
                ...
                'success_rate_improvement': analysis.get('improvement_over_current', 0)
            }
        }, f, indent=2)
