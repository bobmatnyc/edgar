...
async def test_supervisor_web_search():
    ...
    try:
        ...
        print(
            f"   Web Search Used: {'Yes' if 'web search' in str(evaluation).lower() else 'No'}"
        )
...
async def test_controller_web_search():
    ...
    try:
        ...
        print(
            f"   Web Search Client: {'Available' if controller.web_search_client else 'Not Available'}"
        )
...
async def main():
    ...
    parser = argparse.ArgumentParser(
        description="Test EDGAR CLI web search integration"
    )
    parser.add_argument(
        "--test-llm-service", action="store_true", help="Test LLM service web search"
    )
    parser.add_argument(
        "--test-supervisor", action="store_true", help="Test supervisor web search"
    )
    parser.add_argument(
        "--test-engineer", action="store_true", help="Test engineer web search"
    )
    parser.add_argument(
        "--test-controller", action="store_true", help="Test controller web search"
    )
    parser.add_argument(
        "--test-all", action="store_true", help="Run all web search tests"
    )
    ...
    if not any(
        [
            args.test_llm_service,
            args.test_supervisor,
            args.test_engineer,
