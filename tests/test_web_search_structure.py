...
def test_supervisor_structure():
    ...
    try:
        ...
        print(
            f"   • web_search_client: {'Available' if supervisor.web_search_client else 'Not Available'}"
        )
...
def test_engineer_structure():
    ...
    try:
        ...
        print(
            f"   • web_search_client: {'Available' if engineer.web_search_client else 'Not Available'}"
        )
...
def test_controller_structure():
    ...
    try:
        ...
        print(
            f"   • web_search_client: {'Available' if controller.web_search_client else 'Not Available'}"
        )
